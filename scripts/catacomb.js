...
let catacombRooms = [
  ...
  },
  {
    ...
    description: "The Broodmother's Nest looms with arachnid grace. A colossal web, woven with uncanny precision, cradles the monstrous broodmother. Her presence sends shivers, and the air is thick with the scent of impending danger.",
    backgroundImage: "styles/images/corridor-two.png",
    music: null,
    contents: {
      monsters: [BROODMOTHER],
  ...
  },
  {
    ...
    description: "The Skull-lined Corridor echoes with the rattling steps of skeletal sentinels. Walls adorned with grimacing skulls watch as decrepit skeletons and skeletal soldiers patrol with an eerie, mechanical precision.",
    backgroundImage: "styles/images/corridor-one.png",
    music: null,
    contents: {
  ...
  },
  {
    ...
    description: "The Bone-laden Passage exudes the stench of ancient decay. Shadows dance on walls adorned with skeletal remains. Skeletal soldiers stand guard, wielding rusty weapons, while a decrepit skeleton cradles a precious lesser soulstone.",
    backgroundImage: "styles/images/corridor-one.png",
    music: null,
    contents: {
  ...
  },
  {
    ...
    description: "In Skeletons' Rest, decrepit skeletons lie in silent repose. The air is thick with the musty scent of gravebloom, a prized possession amidst the remains. An eerie tranquility belies the dormant threat within the bones.",
    backgroundImage: "styles/images/corridor-one.png",
    music: null,
    contents: {
  ...
  },
  {
    ...
    description: "The Skeletonarium echoes with the metallic clank of skeletal soldiers. Armor-clad and relentless, they guard this chamber of bones. A skeleton key glimmers amid the remains.",
  ...
  {
    roomName: "Bonevault",
    description: "The Bonevault stands as a silent repository of forgotten horrors. Its entrance, locked and foreboding, guards secrets untold. Within, an unsettling stillness hints at the ominous events awaiting those who dare to unlock the mysteries concealed within.",
  ...
  },
  {
    ...
    description: "Within the Skeletal Sepulcher, shadows dance on crumbling bone. Decrepit skeletons stir, guarding their final resting place. A chill pervades as skeletal soldiers stand sentinel.",
    backgroundImage: "styles/images/chamber-one.png",
    music: null,
    contents: {
  ...
  },
  {
    ...
    description: "The Marrowrest Tomb exhales an eerie silence. No living soul stirs, yet the air shivers with the unseen presence of the Graverobber Earver. Unhallowed secrets lie waiting to be unearthed in this solemn sepulcher.",
    backgroundImage: "styles/images/chamber-one.png",
    music: null,
    contents: {
      monsters: [],
  ...
  },
  {
    ...
    description: "In the Ivory Crypt, delicate filigree adorns crypt walls. An ethereal silence lingers, broken only by the occasional skittering. The air is charged with the unsettling energy of the crypt's secrets.",
    backgroundImage: "styles/images/chamber-one.png",
    music: null,
    contents: {
      monsters: [],
  ...
  },
  {
    ...
    description: "Skullcarver's Passage winds through the heart of bone. A colossal bone titan looms, its presence carving fear into the marrow of adventurers.",
    backgroundImage: "styles/images/corridor-one.png",
    music: null,
    contents: {
      monsters: [BONE_TITAN],
  ...
  },
  {
    ...
    description: "The Haunted Hall breathes with ethereal whispers, its walls adorned with drifting specters. A chilling presence lingers, and the air shivers with the haunting melody of unseen spirits.",
    backgroundImage: "styles/images/corridor-one.png",
    music: null,
    contents: {
  ...
  },
  {
    ...
    description: "Within the Echoing Vestibule, shadows seem to converse in ghostly murmurs. A lone haunting spirit glides through the mist, leaving echoes of melancholy. The air is heavy with the presence of lingering sorrow.",
    backgroundImage: "styles/images/corridor-one.png",
    music: null,
    contents: {
      monsters: [HAUNTING_SPIRIT],
  ...
  },
  {
    ...
    description: "The Forgotten Passage is cloaked in darkness, a haven for lurking scoundrels. Their eyes gleaming with mischief.",
    backgroundImage: "styles/images/corridor-two.png",
    music: null,
    contents: {
      monsters: [SCOUNDREL, SCOUNDREL],
  ...
  },
  {
    ...
    description: "The Whispering Hollow breathes with an eerie hush. Shadows dance, concealing elusive shades. Faint whispers beckon, emanating from a lone shade guarding a mysterious whispering amulet, its power shrouded in enigma.",
    backgroundImage: "styles/images/corridor-one.png",
    music: null,
    contents: {
      monsters: [SHADE],
  ...
  },
  {
    ...
    description: "Within the Rattling Hollow, bones assemble in macabre unity. An unsettling rattle permeates the air as a flood of bones, animated and vengeful, guards this chamber. Brave souls may find rare treasures amidst the bone-strewn chaos.",
    backgroundImage: "styles/images/rattling-hollow.png",
    music: null,
    contents: {
