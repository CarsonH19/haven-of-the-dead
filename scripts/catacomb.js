...
let catacombRooms = [
  ...
  },
  {
    ...
    backgroundImage:
      "styles/images/backgrounds/tier-one/broodmother's-nest.jpg",
    music: spiderInvasion,
    contents: {
      monsters: [BROODMOTHER],
      items: [],
  ...
  },
  {
    ...
    backgroundImage: "4styles/images/backgrounds/tier-one/vermin-vestibule.jpg",
    music: deepTunnels,
    contents: {
      monsters: [],
      items: [],
...
let tierTwoRooms = [
  ...
  },
  {
    ...
    description:
      "The Grim Garrison stands in eerie silence. A forsaken commander, a wretched specter, commands unseen forces. The weight of forgotten battles lingers, as the restless commander awaits in the shadows.",
    summary: "",
    backgroundImage: "styles/images/corridor-one.png",
    music: null,
    contents: {
  ...
  },
  {
    ...
    description:
      "A chamber draped in an unsettling aura, dominated by a sprawling pile of skulls. Each skull tells a tale of doom and demise. Grervil the Bodiless, emerges from the bone-strewn depths.",
    summary: "",
    backgroundImage: "styles/images/corridor-two.png",
    music: null,
    contents: {
