...
let catacombRooms = [
  ...
  },
  {
    ...
    backgroundImage: "styles/images/backgrounds/tier-one/flood-of-bones.jpg", //styles/images/backgrounds/tier-one/flood-of-bones-defeated.jpg
    music: passedDanger,
    contents: {
    ...
    switch (roomType) {
      case 1:
        ...
        if (roomDetails === 1) {
          ...
          newRoom.description =
            "Ossuary Outpost, a desolate haven of bone and armor, resonates with the haunting clatter of skeletal soldiers. Amidst the silent echoes, armored skeletons stand guard, their sockets gleaming with an otherworldly intent.";
          newRoom.backgroundImage =
            "styles/images/backgrounds/tier-two/ossuary-outpost.jpg";
        } else {
          newRoom.roomName = "Gravemist Hall";
          newRoom.description =
            "Gravemist Hall, veiled in a perpetual fog, echoes with the melancholic echoes of the deceased. Shadows dance among gravestones as skeletal figures guard the way, their eyes gleaming with spectral vigilance.";
          newRoom.backgroundImage =
